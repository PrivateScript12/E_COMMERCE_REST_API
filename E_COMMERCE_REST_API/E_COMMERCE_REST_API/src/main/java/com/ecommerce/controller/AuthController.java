// kontrola autentikacije i registracije
// api/auth/register i api/auth/login
// generisanje JWT tokena i registracija korisnika
// frontend aplikacija
// spring web, JWT, i openAPI dokumentacija
