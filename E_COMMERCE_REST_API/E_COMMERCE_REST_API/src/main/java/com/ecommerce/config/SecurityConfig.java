// SecurityConfig.java - CORS, JWT Filter, ENDPOINT SEC,
// spring security config for authentication and authorization
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, UserDetailsService userDetailsService) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**", "/h2-console/**", "/swagger-ui/**", "/swagger-ui.html", "/api-docs/**").permitAll()
